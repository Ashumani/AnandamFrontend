...
export const registerLoader = (callback) => {
...
export const loginData = async (username, password) => {
    try {
        const response = await api.post(`${BASE_URL}/users/authenticate`, {
            username,
            password
        });
...
export const fetchAllEmployer = async () => {
    try {
        const response = await api.get(`${BASE_URL}/employer/fetchAllEmployer`, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getEmployee = async (id) => {
    try {
        const response = await api.get(`${BASE_URL}/employee/getEmployee/` + id, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getSalaryReturn = async (id) => {
    try {
        const response = await api.get(`${BASE_URL}/salary/getSalaryReturn/` + id, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const deleteReturnById = async (id) => {
    try {
        const response = await api.delete(`${BASE_URL}/monthly/deleteReturnById/` + id, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getYear = async (id) => {
    try {
        const response = await api.get(`${BASE_URL}/monthly/getYear/` + id, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const fetchEpfReturn = async (id) => {
    try {
        const response = await api.get(`${BASE_URL}/monthly/fetchEpfReturn/` + id, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const deletEsicReturnById = async (id) => {
    try {
        const response = await api.delete(`${BASE_URL}/esic/deleteReturnById/` + id, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const deleteReturnByMonthYear = async (esicid, month, year) => {
    try {
        const response = await api.delete(`${BASE_URL}/esic/deleteReturnByMonthYear/` + esicid + '/' + month + "/" + year, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getSummary = async (id, year, sub_id) => {
    try {
        const response = await api.get(`${BASE_URL}/monthly/getSummary/` + id + '/' + year + '/' + sub_id, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getBill = async (id) => {
    try {
        const response = await api.get(`${BASE_URL}/bill/getBill/` + id, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const searchBill = async (id) => {
    try {
        const response = await api.get(`${BASE_URL}/bill/searchBill/` + id, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getCardsCount = async () => {
    try {
        const response = await api.get(`${BASE_URL}/dashboard/getCardsCount`, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getYearsAndMonth = async () => {
    try {
        const response = await api.get(`${BASE_URL}/dashboard/getYearsAndMonth`, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getAll = async () => {
    try {
        const response = await api.get(`${BASE_URL}/users/getAll`, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getById = async (id) => {
    try {
        const response = await api.get(`${BASE_URL}/users/getById/` + id, { headers: header });
        return response.data
    } catch (error) {
...
export const getUser = async () => {
    try {
        const response = await api.get(`${BASE_URL}/users/current`, { headers: header });
        return response.data
    } catch (error) {
...
export const downlaodFile = async (url) => {
    try {
        ...
        const response = await api.get(`${BASE_URL}/` + url, { responseType: 'blob', headers: header });
...
export const NewsData = async () => {
    try {
        const response = await api.get(`https://newsdata.io/api/1/news?apikey=pub_53971c38bbbb34b05259bb48d72f797e88dc6&q=EPF`);
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const deleteEmployeeById = async (id) => {
    try {
        const response = await api.delete(`${BASE_URL}/employee/delete/`+id , { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const deleteCustomFieldsById = async (id) => {
    try {
        const response = await api.delete(`${BASE_URL}/custom/delete/`+ id, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getAllCustomFields = async () => {
    try {
        const response = await api.get(`${BASE_URL}/custom/getAll`, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getCustomFields = async (param) => {
    try {
        const response = await api.get(`${BASE_URL}/custom/getFields/` + param, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getAllNotification = async () => {
    try {
        const response = await api.get(`${BASE_URL}/notification/getAll`, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getUnreadNotification = async () => {
    try {
        const response = await api.get(`${BASE_URL}/notification/getUnread`, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getNotificationById = async (id) => {
    try {
        const response = await api.get(`${BASE_URL}/notification/` + id, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getEPFChallanCardsDetails = async () => {
    try {
        const response = await api.get(`${BASE_URL}/dashboard/getEPFChallanCardsDetails`, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getESICChallanCardsDetails = async () => {
    try {
        const response = await api.get(`${BASE_URL}/dashboard/getESICChallanCardsDetails`, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const getDSCCardsDetails = async () => {
    try {
        const response = await api.get(`${BASE_URL}/dashboard/getDSCCardsDetails`, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const sendMessage = async (params) => {
    try {
        const response = await api.post(`${BASE_URL}/message/send`,params, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
...
export const recievedMessage = async () => {
    try {
        const response = await api.get(`${BASE_URL}/message/recieved`, { headers: header });
        return response.data
    } catch (error) {
        throw error.response.data.error;
    }
